...
const StoryItem = ({ story }) => {
  return (
    ...
    // <>
    //   <div className="flex bg-base-300  shadow-xl my-4 rounded-lg md:mx-auto  w-full ">
    ...
    //         </p>
    //         <div className="mt-4 flex items-center">
    //           <div className="flex mr-2  text-sm mr-3">
    //             <svg
    //               fill="none"
    //               viewBox="0 0 24 24"
    ...
    //             <span>12</span>
    //           </div>
    //           <div className="flex mr-2  text-sm mr-8">
    //             <svg
    //               fill="none"
    //               viewBox="0 0 24 24"
    //               className="w-4 h-4 mr-1"
    ...
    //             <span>8</span>
    //           </div>
    //           <div className="flex mr-2  text-sm mr-4">
    //             <svg
    //               fill="none"
    //               viewBox="0 0 24 24"
    //               className="w-4 h-4 mr-1"
